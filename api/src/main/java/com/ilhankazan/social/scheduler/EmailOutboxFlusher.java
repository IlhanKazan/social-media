...
public class EmailOutboxFlusher {
    ...
    public void flush() {
        ...
        Boolean lockAcquired = jdbcTemplate.queryForObject("SELECT pg_try_advisory_lock(?)", Boolean.class, ADVISORY_LOCK_ID);
        ...
        try {
            ...
            jdbcTemplate.execute("SELECT pg_advisory_unlock(" + ADVISORY_LOCK_ID + ")");
        }
    }
}
